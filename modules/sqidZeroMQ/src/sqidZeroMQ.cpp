...
{
	return new sqid::Plugins::SqidZeroMQ();
}
...
namespace sqid
{
	namespace Plugins
	{
		SqidZeroMQ::SqidZeroMQ()
		{
			std::cout << "SqidZeroMQ::ctor" << std::endl;
		}

		SqidZeroMQ::~SqidZeroMQ()
		{
			std::cout << "SqidZeroMQ::dtor" << std::endl;
		}

		void SqidZeroMQ::printBuildInfo() const
		{
		...
		bool SqidZeroMQ::init()
		{
			std::cout << "SqidZeroMQ::init" << std::endl;

			return true;
		}

		void SqidZeroMQ::uninit()
		{
			std::cout << "SqidZeroMQ::uninit" << std::endl;

			ZMQSingleton::uninit();
		}

		bool SqidZeroMQ::registerOps()
		{
			std::cout << "SqidZeroMQ::registerOps" << std::endl;

			REGISTER_OP_TYPE( sqid::Plugins::ZMQIn );
			REGISTER_OP_TYPE( sqid::Plugins::ZMQOut );

			return true;
		}

		void SqidZeroMQ::enumerateCaps()
		{
			std::cout << "SqidZeroMQ::enumerateCaps" << std::endl;
		}
	}
}