...
{
	return new sqid::Plugins::SqidMqtt();
}
...
int sqid::Plugins::MQTTContext::HandleCntr = 0;
...
namespace sqid
{
	namespace Plugins
	{
		SqidMqtt::SqidMqtt()
		{
			std::cout << "SqidMqtt::ctor" << std::endl;
		}

		SqidMqtt::~SqidMqtt()
		{
			std::cout << "SqidMqtt::dtor" << std::endl;
		}

		void SqidMqtt::printBuildInfo() const
		{
		...
		bool SqidMqtt::init()
		{
			std::cout << "SqidMqtt::init" << std::endl;

			return true;
		}

		void SqidMqtt::uninit()
		{
			std::cout << "SqidMqtt::uninit" << std::endl;

			MQTTSingleton::uninit();
		}

		bool SqidMqtt::registerOps()
		{
			std::cout << "SqidMqtt::registerOps" << std::endl;

			REGISTER_OP_TYPE( sqid::Plugins::MQTTIn );
			REGISTER_OP_TYPE( sqid::Plugins::MQTTOut );

			return true;
		}

		void SqidMqtt::enumerateCaps()
		{
			std::cout << "SqidMqtt::enumerateCaps" << std::endl;
		}
	}
}