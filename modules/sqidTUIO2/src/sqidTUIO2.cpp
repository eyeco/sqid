...
{
	return new sqid::Plugins::SqidTUIO2();
}
...
namespace sqid
{
	namespace Plugins
	{
		SqidTUIO2::SqidTUIO2()
		{
			std::cout << "SqidTUIO2::ctor" << std::endl;
		}

		SqidTUIO2::~SqidTUIO2()
		{
			std::cout << "SqidTUIO2::dtor" << std::endl;
		}

		void SqidTUIO2::printBuildInfo() const
		{
		...
		bool SqidTUIO2::init()
		{
			std::cout << "SqidTUIO2::init" << std::endl;

			return true;
		}

		void SqidTUIO2::uninit()
		{
			std::cout << "SqidTUIO2::uninit" << std::endl;
		}

		bool SqidTUIO2::registerOps()
		{
			std::cout << "SqidTUIO2::registerOps" << std::endl;

			REGISTER_OP_TYPE( sqid::Plugins::TUIO );
			REGISTER_OP_TYPE( sqid::Plugins::TUIO2SF );

			return true;
		}

		void SqidTUIO2::enumerateCaps()
		{
			std::cout << "SqidTUIO2::enumerateCaps" << std::endl;
		}
	}
}