...
{
	return new sqid::Plugins::SqidAudio();
}
...
namespace sqid
{
	namespace Plugins
	{
		...
		void SqidAudio::printBuildInfo() const
		{
		...
		bool SqidAudio::init()
		{
			std::cout << "SqidAudio::init" << std::endl;

			return true;
		}

		void SqidAudio::uninit()
		{
			std::cout << "SqidAudio::uninit" << std::endl;
		}

		bool SqidAudio::registerOps()
		{
			std::cout << "SqidAudio::registerOps" << std::endl;

			REGISTER_OP_TYPE( sqid::Plugins::AudioIn );
			REGISTER_OP_TYPE( sqid::Plugins::AudioPower );

			return true;
		}

		void SqidAudio::enumerateCaps()
		{
			std::cout << "AudSqidAudioio::enumerateCaps" << std::endl;
		}
	}
}