...
#define DEFINE_FRAMEDRAWER_DESC( _TYPE, _NAME, _GUID ) \
	...
	class SQID_API FrameDrawerLines : public FrameDrawer
	{
	protected:
		bool _autoScale;
		float _scale;
	...
	class SQID_API HistoryDrawerLines : public FrameDrawerLines
	{
	protected:
		size_t _bufferSize;
	...
	class SQID_API FrameDrawer2D : public FrameDrawer
	{
	protected:
	...
	class SQID_API FrameDrawer3D : public FrameDrawer
	{
	private:
		glm::mat4 _proj;
	...
	class SQID_API HistoryDrawerMap : public FrameDrawer2D
	{
	protected:
		size_t _bufferSize;
	...
	class SQID_API PointCloudDrawer : public FrameDrawer3D
	{
	protected:
		virtual void onDraw( const SampleFrame *sf );
