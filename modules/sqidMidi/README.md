# sqıd Plugin for MIDI devices

This repository contains the source code for a MIDI device plugin for the [sqıd visual programming environment](https://github.com/eyeco/sqid), providing source and sink operators for MIDI input and output, to either interact with physical MIDI devices or to communicate with virtual devices using, e.g., [Ableton Live](https://www.ableton.com/en/live/) or [Pure Data](https://puredata.info/).
